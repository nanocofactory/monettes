...
2 - carries by corecursion (over simplicial sets/complexes as higher-order/higher-dimensional object assemblages) rather than by recursion (over graphs/networks as lower-order/lower-dimensional object clusters);<br>
